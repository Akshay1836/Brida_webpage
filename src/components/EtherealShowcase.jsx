  ...
  >
    <div className="ethereal-hero-content">
      ...
      <p className="ethereal-hero-desc">
        Discover a luxurious you with the perfect balance of natural beauty & an ethereal new glow
      </p>
      <button className="ethereal-hero-btn">ENQUIRE</button>
    </div>
  </section>
);

export default EtherealShowcase;
